...
type Request struct {
	...
	MsgCount uint32   `protobuf:"varint,1,opt,name=msgCount,proto3" json:"msgCount,omitempty"`
...
func (x *Request) GetMsgCount() uint32 {
	if x != nil {
		return x.MsgCount
	}
	return 0
...
func (x *RepoEventLog) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*RepoEventLog) ProtoMessage() {}

func (x *RepoEventLog) ProtoReflect() protoreflect.Message {
	mi := &file_pkg_proto_client_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use RepoEventLog.ProtoReflect.Descriptor instead.
func (*RepoEventLog) Descriptor() ([]byte, []int) {
	return file_pkg_proto_client_proto_rawDescGZIP(), []int{2}
}

func (x *RepoEventLog) GetRequest() *Request {
	if x != nil {
		return x.Request
	}
	return nil
...
var file_pkg_proto_client_proto_rawDesc = []byte{
	...
	,
...
var file_pkg_proto_client_proto_goTypes = []interface{}{
	(*Request)(nil),             // 0: client.v1.Request
	(*SubscriptionRequest)(nil), // 1: client.v1.SubscriptionRequest
	(*RepoEventLog)(nil),        // 2: client.v1.RepoEventLog
}
var file_pkg_proto_client_proto_depIdxs = []int32{
	0, // 0: client.v1.RepoEventLog.request:type_name -> client.v1.Request
	1, // 1: client.v1.Replicator.Subscribe:input_type -> client.v1.SubscriptionRequest
	2, // 2: client.v1.Replicator.Subscribe:output_type -> client.v1.RepoEventLog
